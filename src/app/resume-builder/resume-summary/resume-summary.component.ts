...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,RouterModule,ResumeBuilderComponent,ResumeHeaderComponent,ResumeExperienceComponent,ResumeEducationComponent,
    ResumeSkillsComponent,ReactiveFormsModule,FormsModule,],
